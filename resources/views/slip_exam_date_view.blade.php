...
@section('title', 'Driver\'s Exam Date Slip')
                                ...
                                <a href="javascript:;" class="icon-remove"></a>
                                 ...
                                 <div class="clearfix no-print">
                                     <div class="btn-group pull-right">
                                      <a class="btn" href="{{ url('/invoice') }}/{{ $driver->id }}" target="_blank">Print</a>
                                     </div>
                                 </div>
                         <div class="widget-body">
                             <div>
                                <a href="{{ url('/add-new-driver') }}" class="btn btn-primary">Add New Driver</a>
