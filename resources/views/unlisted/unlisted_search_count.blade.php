...
@section('title', 'Unlisted Driver Search By Date Range')
            ...
            <div class="row-fluid">
                ...
                <div class="span5">
                <form action="{{ url('/unlisted-search-count') }}" method="get" class="hidden-phone">
                    {{ csrf_field() }}
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-green">
                        <a data-original-title="" href="{{ url('unlisted-prof-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($prof) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-green">
                        <a data-original-title="" href="{{ url('unlisted-nonprof-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($non_prof) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('unlisted-light-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($light) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('unlisted-lightmotorcycle-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('unlisted-medium-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($medium) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('unlisted-heavy-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($heavy) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('unlisted-psv-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($psv) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-blue">
                        <a data-original-title="" href="{{ url('unlisted-new-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($new) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-blue">
                        <a data-original-title="" href="{{ url('unlisted-renew-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($renew) }}
                            </div>
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-grey ">
                        <a data-original-title="" href="{{ url('unlisted-total-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
