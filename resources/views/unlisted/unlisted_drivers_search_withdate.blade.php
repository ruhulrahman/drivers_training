...
@section('title', 'Exam Unlisted Drivers Search')
  ...
  table tr td{text-align: center !important;}
            ...
            <!-- BEGIN EDITABLE TABLE widget-->
             <div class="row-fluid">
                ...
                <form action="{{ url('/unlisted-drivers-search-withdate') }}" method="post" class="">
                    {{ csrf_field() }}
                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                     <tbody>
                      <tr>
                        <td colspan="3"><span style="font-size: 20px; font-weight: 700;">Exam Unlisted Total Driver Search By Exam Date Range</span></td>
                      </tr>
                       <tr class="">
