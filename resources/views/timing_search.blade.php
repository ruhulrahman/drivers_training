...
@section('title', 'Timing Driver Search')
            ...
            <div class="row-fluid">
                ...
                <div class="span5">
                <form action="{{ url('/timing-search') }}" method="get" class="hidden-phone">
                    {{ csrf_field() }}
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-green">
                        <a data-original-title="" href="{{ url('prof-driver-search-by-date') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($prof) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-green">
                        <a data-original-title="" href="{{ url('nonprof-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($non_prof) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('light-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($light) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('lightmotorcycle-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('medium-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($medium) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('heavy-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($heavy) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-red">
                        <a data-original-title="" href="{{ url('psv-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($psv) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-blue">
                        <a data-original-title="" href="{{ url('new-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($new) }}
                            </div>
                    ...
                    <div class="metro-nav-block nav-block-blue">
                        <a data-original-title="" href="{{ url('renew-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
                            <i class="icon-user"></i>
                            <div class="info">
                                {{ count($renew) }}
                            </div>
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-grey ">
                        <a data-original-title="" href="{{ url('total-driver-search') }}/{{ $start_date }}/{{ $end_date }}">
