                ...
                <div class="span5">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="{{ url('/class-create') }}" method="post" id="scl_form" class="form-horizontal">
                                {{ csrf_field() }}
                                <div class="control-group">
                                    <label for="class_name" class="control-label">Class Name</label>
                                    <div class="controls">
                                        <input type="text" name="class_name" id="class_name" placeholder="Enter class name" class="input-medium" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
