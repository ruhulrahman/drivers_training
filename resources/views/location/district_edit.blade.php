            ...
            <div class="span6">
              <section class="widget red">
                ...
                <div class="alert alert-success print-success-msg text-center" style="display: none;"></div>
                    <form id="dm_form" action="{{ url('/district-update') }}" method="post" class="form-inline" role="form">
                      @csrf
                        ...
                        <input type="hidden" name="dis_id" value="{{ $dis->id }}">
                                <table class="table table-bordered">
                                  ...
                                  <tr>
                                    <td>District Name</td>
                                    <td>
                                      <input type="text" name="dis_name" value="{{ $dis->dis_name }}" class="form-control" id="dis_name" placeholder="Enter District Name">
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Sumission</td>
