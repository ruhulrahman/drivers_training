            ...
            <div class="span6">
              <section class="widget red">
                ...
                <div class="alert alert-success print-success-msg text-center" style="display: none;"></div>
                    <form id="data_form" action="{{ url('/tana-update') }}" method="post" class="form-inline" role="form">
                      @csrf
                      @foreach ($tana as $thn)
                        <input type="hidden" name="thnid" value="{{ $thn->id }}" id="">
                    ...
                    get();
                                  ...
                                  <tr>
                                    <td>Tana Name</td>
                                    <td>
                                        <input type="text" name="tana_name" value="{{ $thn->tana_name }}" class="form-control" id="tana_name" placeholder="Enter tana Name">
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Sumission</td>
