  ...
  table tr td{text-align: center !important;}
            ...
            <!-- BEGIN EDITABLE TABLE widget-->
             <div class="row-fluid">
                ...
                <form action="{{ url('/timing-search-total-list') }}" method="post" class="">
                    {{ csrf_field() }}
                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                     <tbody>
                      <tr>
                        <td colspan="3"><span style="font-size: 20px; font-weight: 700;">Total Driver Search By Exam Date</span></td>
                      </tr>
                       <tr class="">
