...
@section('title', 'Total Drivers Lists')
<script>
  function aa(id)
  {
    // window.open(document.location.href="{{  url('/invoice/') }}/"+id);
    // alert(id);
  }
</script>
<style>
                                     ...
                                     <tbody>
                                      ...
                                      @if (count($drivers) > 0)
                                       ...
                                       <tr class="">
                                        ...
                                        ?></td>
                                           <td class="no-print"><button onclick="aa('<?php print $driver->id?>')"><i style="font-size: 25px;" class="icon-eye-open no-print"></button></i></td>
                                           <td class="no-print">
