...
class webcamClass extends connectionClass{
    private $imageFolder="public/img/temp/";
    ...
    private function getNameWithPathForSaveFile(){
    ...
    public function showImage(){
        ...
        {
            $this->saveImageToDatabase($this->getNameWithPathForSaveFile());         // this line is for saveing image to database
            return $this->getNameWithPathForSaveFile();
        }
